...
const GetStartedView = ({
  ...
  return (
    ...
    >
      <div className="flex flex-row w-screen h-full sm:flex-col bg-neutral-950">
        <div className="sm:mt-0 md:w-[40%] m-auto flex flex-col justify-center items-center h-screen">
          <div className="flex items-center justify-center text-center">
            <div className="flex flex-col gap-4 md:w-fit m-10">
              <h1 className="text-2xl font-light md:text-3xl text-white">
                Welcome to{" "}
              ...
              <div className="flex items-center justify-center py-5">
                <video
                  src="https://bavebtaidiqnrgh4.public.blob.vercel-storage.com/RealplyAI_4-k5XwGae7bklNQBE3OUzsEbGpVrNzKg.webm"
                  autoPlay
                  muted
                  loop
                  className="w-[20%]"
              ...
              <div className="my-3 w-inherit">
                ...
                >
                  <div className="flex items-center justify-center gap-2 group">
                    <h1 className="text-lg font-light bg-white group-hover:bg-gradient-to-r from-[#726BF2] to-[#FF8FFB] bg-clip-text text-transparent transition-all duration-300">
                      Get Started
                    </h1>
                    <svg
                      width="18"
                    ...
                    >
                      <path
                        ...
                        className="fill-white group-hover:fill-[#726BF2] group-hover:translate-x-[5.2px] transition-all duration-300"
                      ></path>
                      <path
                        d="M1.75 8H11"
                        strokeWidth="1.5"
